...
";
    ...
    $in_time=$row8["in_time"];
            ...
            $query19="delete from freeup where car_id=".$leave_car_id."";
            mysqli_query($conn,$query19)or die("hell");
    ...
    -->
      ...
      <div class="container-fluid">
        ...
        <center>
          ...
          <br>
          <br>
          <h4 class="title">Enter car details to add or remove car from the parking slot</h4>
        </center>
    <div class="details my-2 mx-2">
        <form id="entry_form" class="entry_delete"  method="post" action="add_delete_slot.php">
            <label class="form-label" for="entry_car_id">Enter Car ID:</label>
            <input class="form-control" type="text" 
            id="entry_car_id"
            name="entry_car_id" class="car_id" placeholder="Enter Car Id" required>
            
            <label class="form-label" for="slot_id">Enter the Lot Id:</label>
            ...
            <button class="btn btn-primary" name="request"><a href="request_table.php" style="text-decoration:none;color:white">See Incoming Requests</a></button>
            <button class="btn btn-primary" name="request"><a href="request_out.php" style="text-decoration:none;color:white">See Outgoing Requests</a></button>

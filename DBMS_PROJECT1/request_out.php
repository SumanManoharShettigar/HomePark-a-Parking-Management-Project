...
$query9 = "select r.owner_id,r.car_id,c.car_license_plate,o.owner_fname,o.owner_lname,o.owner_license_no,o.owner_phno from freeup r,owner_table o,car_table c where r.owner_id=o.owner_id and r.car_id=c.car_id";
  ...
  <body>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-ygbV9kiqUc6oa4msXn9868pTtWMgiQaeYH7/t7LECLbyPA2x65Kgf80OJFdroafW" crossorigin="anonymous"></script>
      ...
      <div class="container-fluid">
        ...
        <br>
        <center>
          <h1 class="title">Outgoing Slot Requests</h1>
          <br>
          <br>

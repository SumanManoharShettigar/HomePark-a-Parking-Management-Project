...
$occupied_query="select c.car_id,c.car_license_plate,o.owner_license_no,o.owner_fname,o.owner_lname,o.owner_phno,o.owner_id,o.owner_addrs from car_table c,owner_table o where  c.owner_id = o.owner_id and c.owner_id=".$_SESSION['log_name']."";
...
<html lang="en">
  <head>
    ...
    <title>MY VEHICLE DETAILS</title>
  ...
  <body>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-ygbV9kiqUc6oa4msXn9868pTtWMgiQaeYH7/t7LECLbyPA2x65Kgf80OJFdroafW" crossorigin="anonymous"></script>
      ...
      <div class="container-fluid">
        ...
        <br>
        <center>
          <h1 class="title">MY VEHICLE DETAILS</h1>
        ...
        echo '
           ...
           <button name="ret"><a href="user_home.php">Go Back</a></button>
